...
<meta charset="UTF-8">
<title>图书馆首页</title>
<link href="/wdh/library/css/main.css" rel="stylesheet"/>
</head>
<body>
	<form method="get">
...
<%-- 	<%
	...
	<c:forEach items="${page.content }" var="book">
		...
		<div class="item">
			<img style="" alt="" src="/wdh/library/images/${book.image }" />
			<div class="name">
				${book.name }
			</div>
			<div class="buttons">
				<span onclick="document.location.href='/wdh/library/debit?bookId=${book.id}'">+</span>
			</div>
		</div>
	</c:forEach>
